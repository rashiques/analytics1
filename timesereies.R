...
#Yearly----
(ysales = ts(sales, frequency = 1))#yearly data

(yearlysales = ts(sales, start=c(1980), frequency=1))#start at 1980
...
methods(class=ts)
yearlysales1
(w1= window(yearlysales1, start=1990, end=1996))#data start from 1990 and 1996
plot(w1)
