...
#(https://www.r-graph-gallery.com/the-wordcloud2-library/) for more wordcloud
...
?wordcloud2
#MYOWN CREATION
word1=c('player','football','messi','legend')
freq=c(30,42,46,36)
...
wordcloud2(demoFreq, size=0.4, color=rep_len( c("green","blue"), nrow(demoFreq) ) )

# Change the background color
wordcloud2(demoFreq, size=0.8, color='random-light', backgroundColor="black")
