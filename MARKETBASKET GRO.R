...
frequentItems = eclat (Groceries, parameter = list(supp = 0.01, minlen= 2, maxlen = 5)) #0.01*9835 TIME THE ITMES DSHOULD BROUGHT AND SHOULD BE TWO ITEM OR MAX 5 ITEM TOGETHER
...
subset1 = subset(rules2, subset=rhs %in% "whole milk")  # whole milk in rIGHT HND DIDE rhs
...
plot(subset1[1:10]) #visualising using graph
